...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pixel_size",
        type=int,
        help="pixel size of the square side of generated image",
        default=128,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_path", type=str, help="path to save the image", default=None
    )
    args = parser.parse_args()

    rune_tag = Runetag(
        num_layers=args.num_layers, num_dots_per_layer=args.num_dots_per_layer
    )
