...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run the semantic segmentation model on webcam")
    parser.add_argument("--model_path", type=str, default="model.pt", help="Path to the model ")
